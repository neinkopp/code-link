...
class Swipe extends Model
{
	...
	{ //jeder Swipe gehört zu einem User,der ihn gesendet hat. 

		return $this->belongsTo(User::class, 'from_user_id');
	}
	public function toUser()
	{ //jeder swipe geört zu einem User der ihn erhalten hat. 
		return $this->belongsTo(User::class, 'to_user_id');
	}

	public $timestamps = false; //deaktiviert die automatische Zeitstempelfunktion von Laravel
